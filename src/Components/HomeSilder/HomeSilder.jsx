...
export default function HomeSilder() {
    const silderImages = [
        { img: "https://images.unsplash.com/photo-1487744480471-9ca1bca6fb7d?q=80&w=2691&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", id: 1 },
        { img: image2, id: 2 },
        { img: image3, id: 3 },
    ];
    return (
